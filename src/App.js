    ...
    super(props);
        ...
        this.state = {
            data : [{
                firstName:"Rishabh", 
                lastName:"Gupta", 
                state: "Uttar Prasdesh",
                city: "Etawah",
                email: "rishabh.gupta@gmail.com"
            }],
...
var heading = this.state.title.map((head)=>
    ...
    var loginPage = (
                      ...
                      <p>NOTE :- Please see readme file for username and password as I have not used backend.</p>
                      </Form>                    
                        </div>
